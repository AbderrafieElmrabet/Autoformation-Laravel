        ...
        <div class="row">
          ...
          <div class="col-lg-6 text-center mt-lg-0 mt-md-5 mt-4">
            <div class="image-block position-relative">
              <img src="../images/1.png" alt="" class="img-fluid mt-lg-0 mt-4">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="owl-carousel owl-theme" id="owl-demo1">
          <div class="item">
            <div class="grids4-info">
              <a href="#"><img class="img-fluid" src="../images/casablanca.png" alt="" /></a>
              <div class="info-bg">
          ...
          <div class="item">
            <div class="grids4-info">
              <a href="#"><img class="img-fluid" src="../images/Marrakech.png" alt="" /></a>
              <div class="info-bg">
          ...
          <div class="item">
            <div class="grids4-info">
              <a href="#"><img class="img-fluid" src="../images/Rabat.png" alt="" /></a>
              <div class="info-bg">
          ...
          <div class="item">
            <div class="grids4-info">
              <a href="#"><img class="img-fluid" src="../images/Tanger.png" alt="" /></a>
              <div class="info-bg">
          ...
          <div class="item">
            <div class="grids4-info">
              <a href="#"><img class="img-fluid" src="../images/Agadir.png" alt="" /></a>
              <div class="info-bg">
          ...
          <div class="item">
            <div class="grids4-info">
              <a href="#"><img class="img-fluid" src="../images/Fes.png" alt="" /></a>
              <div class="info-bg">
          ...
          <div class="item">
            <div class="grids4-info">
              <a href="#"><img class="img-fluid" src="../images/Ouarzazate.png" alt="" /></a>
              <div class="info-bg">
          ...
          <div class="item">
            <div class="grids4-info">
              <a href="#"><img class="img-fluid" src="../images/Essaouira.png" alt="" /></a>
              <div class="info-bg">
          ...
          <div class="item">
            <div class="grids4-info">
              <a href="#"><img class="img-fluid" src="../images/Chefchaouen.png" alt="" /></a>
              <div class="info-bg">
      ...
      <div class="container py-lg-5 py-md-3">
        <div id="owl-agency" class="owl-carousel owl-theme py-2 mb-4 text-center">
          ...
          <div class="item">
            <div class="testimonial-content">
              <div class="testimonial">
                <a class="comment-img" href="#url"><img src="../images/team3.jpg" class="img-responsive"
                    alt="placeholder image"></a>
                <blockquote>
                  <q>OMG! I cannot believe. It's Awesome</q>
                </blockquote>
          ...
          <div class="item">
            <div class="testimonial-content">
              <div class="testimonial">
                <a class="comment-img" href="#url"><img src="../images/team4.jpg" class="img-responsive"
                    alt="placeholder image"></a>
                <blockquote>
                  <q>OMG! I cannot believe. It's Awesome</q>
                </blockquote>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Solicode\Projects\univers-de-Laravel\miniProjet\resources\views/home.blade.php ENDPATH**/ ?>